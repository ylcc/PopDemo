...
- (void)updateNavigationBarAniamted:(BOOL)animated
{
    ...
    _navigationBar.topItem.rightBarButtonItems = topViewController.navigationItem.leftBarButtonItems ? : (topViewController.navigationItem.hidesBackButton ? nil : @[ _defaultLeftBarItem ]);
    _navigationBar.topItem.leftBarButtonItem = topViewController.navigationItem.rightBarButtonItems;
...
- (void)setupNavigationBar
{
    ...
    [_navigationBar setBottomBorderColor:[ThemeManager shareTheme].lineColor height:0.5];
